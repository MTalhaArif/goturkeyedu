      ...
      <section id="hero" className="hero">
        ...
        <div className="hero-slides-wrap">
          {heroSlides.map((slide, i) => {
            ...
            // Only the active slide's heading is an <h1> — all 5 slides render into the DOM
            // at once (opacity toggle, not unmount/conditional render), so making every one
            // an <h1> would give the page 5 top-level headings instead of 1.
            ...
            return (
              ...
              >
                <div className="hero-content">
                  <TitleTag>{t[slide.titleKey]}</TitleTag>
                  <p>{t[slide.subKey]}</p>
